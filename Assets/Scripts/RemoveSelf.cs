...
public class RemoveSelf : StateMachineBehaviour {
  // OnStateEnter is called before OnStateEnter is called on any state inside
  // this state machine
  ...
  // OnStateUpdate is called before OnStateUpdate is called on any state inside
  // this state machine
  ...
  // OnStateExit is called before OnStateExit is called on any state inside this
  // state machine
  ...
  // OnStateMove is called before OnStateMove is called on any state inside this
  // state machine
